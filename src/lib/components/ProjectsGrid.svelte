...
<section id="projects" class="projects-section snap-start">
	<!-- Scrolling rows -->
	<div class="rows-wrap">
					...
					{:else}
						...
						{#each row as proj (proj.id + '-' + rowIdx + '-a')}
							<a
								...
								rel="noopener"
								title={proj.title}
								onclick={() => trackProjectClick(proj.title)}
							>
								<img
	...
	<div class="center-overlay">
		...
		<p class="center-desc">Ideas built into reality — each one a story of creativity and code.</p>
	</div>
</section>
